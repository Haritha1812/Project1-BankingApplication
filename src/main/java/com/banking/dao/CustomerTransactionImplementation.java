...
public class CustomerTransactionImplementation implements CustomerTransactionDAO{
    ...
    public List<CustomerTransaction> getCustomerTransactionById(int customerId) {
        ...
        Query query=session.createQuery("com.banking.model.CustomerTransaction where customerId="+customerId);
	...
	public List<CustomerTransaction> getAllCustomerTransaction() {
		...
		Query query=session.createQuery("from com.banking.model.CustomerTransaction");
		List<CustomerTransaction>  customerTransaction=query.list();
		return customerTransaction;
	}
