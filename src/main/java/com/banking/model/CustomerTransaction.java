...
public class CustomerTransaction {
    ...
    public CustomerTransaction(int transactionId, int customerId, int balance, int withdrawn, int deposit,
			int transferredAmount, Date transactionDate, int toAccount, int fromAccount) {
		super();
